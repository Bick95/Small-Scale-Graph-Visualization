...
class Graph():
  ...
  def visualize(self, html=False):
    ...
    r_min = 40    # Min radius of outer circle along which points lie
    ...
    for i in range(len(self.edges)):
      ...
      if edge[0] != edge[1]:
        ...
        scaled_displacement = vector_arithmetics(displacement_dir, '*', 10.)
    ...
    for i in range(len(self.edges)):
      ...
      if edge[0] == edge[1]:
        ...
        scaled_pt_dir = vector_arithmetics(pt_dir, '*', 30)  # Scale direction, determine distance of label from node
